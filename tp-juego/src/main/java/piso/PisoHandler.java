...
public class PisoHandler {
    ...
    public PisoHandler() {
        ...
        pisos.put(2.0, new Piso("file:src/main/resources/sprites/limite_pasar_nivel/valla_cerrada_este.png", true, nombres[2]));
        pisos.put(2.1, new Piso("file:src/main/resources/sprites/limite_pasar_nivel/valla_cerrada_sur.png", true, nombres[2]));
        pisos.put(2.2, new Piso("file:src/main/resources/sprites/limite_pasar_nivel/valla_cerrada_oeste.png", true, nombres[2]));
        pisos.put(2.3, new Piso("file:src/main/resources/sprites/limite_pasar_nivel/valla_cerrada_norte.png", true, nombres[2]));

        // Pasar nivel habilitado
        pisos.put(3.0, new Piso("file:src/main/resources/sprites/limite_pasar_nivel/valla_abierta_este.png", false, nombres[2]));
        pisos.put(3.1, new Piso("file:src/main/resources/sprites/limite_pasar_nivel/valla_abierta_sur.png", false, nombres[2]));
        pisos.put(3.2, new Piso("file:src/main/resources/sprites/limite_pasar_nivel/valla_abierta_oeste.png", false, nombres[2]));
        pisos.put(3.3, new Piso("file:src/main/resources/sprites/limite_pasar_nivel/valla_abierta_norte.png", false, nombres[2]));

        // Pisos item pasar nivel
        pisos.put(6.0, new Piso("file:src/main/resources/sprites/piso_item_pasar_nivel/cofre_cerrado.png", true, nombres[2]));
        pisos.put(6.1, new Piso("file:src/main/resources/sprites/piso_item_pasar_nivel/cofre_abierto.png", false, nombres[2]));
